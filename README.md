native-dnssec-dns - Updated for DNSSEC records
==============================================

Installation
------------

`npm install native-dnssec-dns` and then `var dns = require('native-dnssec-dns');`

Client
------

native-dnssec-dns exports what should be a 1:1 mapping of the upstream node.js dns
module. That is to say if it's listed in the [docs](http://nodejs.org/docs/latest/api/dns.html)

Request
-------

Beyond matching the upstream module, native-dnssec-dns also provides a method for
customizing queries.
